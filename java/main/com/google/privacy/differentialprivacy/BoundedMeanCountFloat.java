 ...
 */
public class BoundedMeanCountFloat {
    private final BoundedMeanCountFloat.Params params;
    ...
    private BoundedMeanCountFloat(BoundedMeanCountFloat.Params params) {
        this.params = params;
    ...
    public static BoundedMeanCountFloat.Params.Builder builder() {
        return BoundedMeanCountFloat.Params.Builder.newBuilder();
    }
    ...
    public void reset(){
        ...
        this.normalizedSum.resultReturned = false;
        this.count.resultReturned = false;
    }
    ...
    public abstract static class Params {
        ...
        public abstract static class Builder {
            ...
            private static BoundedMeanCountFloat.Params.Builder newBuilder() {
                BoundedMeanCountFloat.Params.Builder builder = new AutoValue_BoundedMeanCountFloat_Params.Builder();
            ...
            public abstract BoundedMeanCountFloat.Params.Builder epsilon(double value);
             ...
             * noise is used.
             */
            public abstract BoundedMeanCountFloat.Params.Builder delta(@Nullable Double value);

            /**
             * Maximum number of partitions that a single privacy unit (e.g., an individual) is allowed to
             * contribute to.
             */
            public abstract BoundedMeanCountFloat.Params.Builder maxPartitionsContributed(int value);

            /** Max contributions per partition from a single privacy unit (e.g., an individual). */
            public abstract BoundedMeanCountFloat.Params.Builder maxContributionsPerPartition(int value);

            /** Noise that will be used to make the mean differentially private. */
            public abstract BoundedMeanCountFloat.Params.Builder noise(Noise value);

            /**
             * Lower bound for the entries added to the mean. Lower values will be clamped to this bound.
             */
            public abstract BoundedMeanCountFloat.Params.Builder lower(double value);

            /**
             * Higher bound for the entries added to the mean. Greater values will be clamped to this
             * bound.
             */
            public abstract BoundedMeanCountFloat.Params.Builder upper(double value);

            abstract BoundedMeanCountFloat.Params autoBuild();

            public BoundedMeanCountFloat build() {
                BoundedMeanCountFloat.Params params = autoBuild();
                ...
                return new BoundedMeanCountFloat(params);
            }
        }
    }
}
